...
// arModel is a active record design model for table gvg_member_extra operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gvg_member_extra.
	Table = "gvg_member_extra"
	// Model is the model object of gvg_member_extra.
