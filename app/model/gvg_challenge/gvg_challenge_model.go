...
// arModel is a active record design model for table gvg_challenge operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gvg_challenge.
	Table = "gvg_challenge"
	// Model is the model object of gvg_challenge.
