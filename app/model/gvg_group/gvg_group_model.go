...
// arModel is a active record design model for table gvg_group operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gvg_group.
	Table = "gvg_group"
	// Model is the model object of gvg_group.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gvg_group.
	Columns = struct {
		GvgId               string //   
        GroupId             string //   
        CreateQqid          string //   
        ...
        BossLockMsg         string //   
        BossLockTime        string //   
        ChallengeStratTime  string //   
        ChallengeStratQqid  string //   
        GvgStartTime        string //   
        GvgEndTime          string //   
        Time                string //
	}{
		GvgId:              "gvg_id",                
        GroupId:            "group_id",              
        CreateQqid:         "create_qqid",           
        GameServer:         "game_server",           
        GvgName:            "gvg_name",              
        BossCycle:          "boss_cycle",            
        BossNum:            "boss_num",              
        BossHp:             "boss_hp",               
        BossLockQqid:       "boss_lock_qqid",        
        BossLockType:       "boss_lock_type",        
        BossLockMsg:        "boss_lock_msg",         
        BossLockTime:       "boss_lock_time",        
        ChallengeStratTime: "challenge_strat_time",  
        ChallengeStratQqid: "challenge_strat_qqid",  
        GvgStartTime:       "gvg_start_time",        
        GvgEndTime:         "gvg_end_time",          
        Time:               "time",
	}
)
