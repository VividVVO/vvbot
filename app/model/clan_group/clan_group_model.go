...
// arModel is a active record design model for table clan_group operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of clan_group.
	Table = "clan_group"
	// Model is the model object of clan_group.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table clan_group.
	Columns = struct {
		GroupId       string //   
        GroupName     string //   
        Privacy       string //   
        ...
        Privacy:      "privacy",        
        CreatorQqid:  "creator_qqid",   
        GameServer:   "game_server",    
        Notification: "notification",   
        GvgId:        "gvg_id",         
        BindQqGroup:  "bind_qq_group",  
        Apikey:       "apikey",         
