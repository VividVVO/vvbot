...
// arModel is a active record design model for table clan_member operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of clan_member.
	Table = "clan_member"
	// Model is the model object of clan_member.
