...
// arModel is a active record design model for table user_login operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of user_login.
	Table = "user_login"
	// Model is the model object of user_login.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table user_login.
	Columns = struct {
		Qqid        string //   
        AuthCookie  string //   
        LoginTime   string //   
