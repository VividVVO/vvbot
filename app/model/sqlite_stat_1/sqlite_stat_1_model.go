...
// arModel is a active record design model for table sqlite_stat1 operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sqlite_stat1.
	Table = "sqlite_stat1"
	// Model is the model object of sqlite_stat1.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sqlite_stat1.
	Columns = struct {
		Tbl   string //   
        Idx   string //   
        Stat  string //
