...
// arModel is a active record design model for table sqlite_sequence operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sqlite_sequence.
	Table = "sqlite_sequence"
	// Model is the model object of sqlite_sequence.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sqlite_sequence.
	Columns = struct {
		Name  string //   
        Seq   string //
	}{
